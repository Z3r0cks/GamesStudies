...
public class EnablePassThrough_cmd : MonoBehaviour
{
    ...
    private void Awake() {
        #if UNITY_EDITOR
        path = System.IO.Path.Combine(Directory.GetCurrentDirectory() + "\\Assets\\Samples\\VIVE OpenXR Plugin - Windows\\1.0.10\\SceneUnderstanding Example\\PassThrough Plugin\\OfflineTool.exe");
